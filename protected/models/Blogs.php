...
class Blogs extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('titulo, imagen, fecha, contenido, id_categoria', 'required'),
			array('id_categoria', 'numerical', 'integerOnly'=>true),
			array('titulo, imagen', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, titulo, imagen, fecha, contenido, id_categoria', 'safe', 'on'=>'search'),
		);
	}
