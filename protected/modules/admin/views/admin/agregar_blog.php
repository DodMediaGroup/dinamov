...
<div class="content">
	<div class="page-heading">
		<h1><i class='fa fa-book'></i> Agregar Blog</h1>
		<h3>A continuación puedes agregar un blog</h3>            	</div>
	<!-- Page Heading End-->				<!-- Your awesome content goes here -->
	<form id="form_servicio" action="<?php echo Yii::app()->request->baseUrl; ?>/admin/agregar_blogs/" enctype="multipart/form-data" method="post">
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
			...
			<div class="col-md-12">
				<div class="widget">
					<div class="widget-header" style="text-align:center">
						<h2><strong>Almacenar Blog</strong></h2>
					</div>
					<div class="widget-content padding" style="text-align:center">
						<input type="submit" class="btn btn-primary" value="Almacenar y Publicar Blog">
					</div>
				</div>
			</div>
		</div>
