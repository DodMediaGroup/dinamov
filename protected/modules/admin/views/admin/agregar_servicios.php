...
<div class="content">
	<div class="page-heading">
		<h1><i class='fa fa-sitemap'></i> Agregar Servicios</h1>
		<h3>A continuación puedes editar el servicio</h3></div>
	<!-- Page Heading End-->				<!-- Your awesome content goes here -->
	<form id="form_servicio" action="<?php echo Yii::app()->request->baseUrl; ?>/admin/admin/agregar_servicios/" enctype="multipart/form-data" method="post">
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-content padding">
						...
						<textarea name="subtitulo" class="summernote"></textarea>
						<br>
					</div>
				</div>
				...
				<div class="widget">
					...
					<div class="widget-content padding">
						<textarea name="caracteristicas" class="summernote"></textarea>
						<br>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	$("#agregar_servicios").addClass('active');
