...
<div class="content">
	<div class="page-heading">
		<h1><i class='fa fa-book'></i> Blog <b><i><?php echo $blog->titulo ?></i></b></h1>
		<h3>A continuación puedes editar el servicio</h3>            	</div>
	<!-- Page Heading End-->				<!-- Your awesome content goes here -->
	<form id="form_servicio" action="<?php echo Yii::app()->request->baseUrl; ?>/admin/admin/editar_blog/<?php echo $blog->id ?>" enctype="multipart/form-data" method="post">
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-content padding">
						...
						<label>Titulo</label>
						<input type="text" name="titulo" class="form-control" value="<?php echo $blog->titulo ?>">
						<br>
					</div>
				</div>
					...
					<div class="widget-content padding">
						<div class="row">
							<div class="col-md-12" id="respuesta" style="text-align:center">
								<img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $blog->imagen ?>">
							</div>
						</div>
						<hr>
						<div class="row">
				...
				<div class="widget">
					...
					<div class="widget-content padding">
						<textarea name="contenido" class="summernote"><?php echo $blog->contenido ?></textarea>
						<br>
					</div>
				</div>
			</div>
